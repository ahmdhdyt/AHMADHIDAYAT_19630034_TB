...
//        Memanggil Data Kelas
    ...
    private void initComponents() {
        ...
        stasiun_tujuan = new javax.swing.JComboBox<String>();
        ...
        fnama.setBackground(new java.awt.Color(255, 255, 51));
        ...
        jLabel4.setText("Bandara Tujuan     :");

        stasiun_tujuan.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        stasiun_tujuan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Jakarta (CKG)", "Balikpapan (BPN)", "Bandung (BDO)", "Surabaya (SUB)", "Pontianak (PNK)." }));
        stasiun_tujuan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stasiun_tujuanActionPerformed(evt);
            }
        });
        ...
        fid.setBackground(new java.awt.Color(255, 255, 0));
        ...
        ckereta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "City Link", "Garuda Indonesia", "Lion Air" }));
        ...
        fbayar.setBackground(new java.awt.Color(255, 255, 51));
        ...
        stasiun_awal.setText("Banjarmasin (BDJ)");
    ...
    private void ckeretaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckeretaActionPerformed
        ...
        if(ckereta.getSelectedItem().equals("City Link")){
        bayangan4.setValue(1);
        ckereta.setSelectedIndex(1);
       }else if(ckereta.getSelectedItem().equals("Garuda Indonesia")){
       bayangan4.setValue(2);
       ckereta.setSelectedIndex(2);
       }
       else if(ckereta.getSelectedItem().equals("Lion Air")){
       bayangan4.setValue(3);
       ckereta.setSelectedIndex(3);
       }

       if(ckereta.getSelectedItem().equals("City Link") && stasiun_tujuan.getSelectedItem().equals("Jakarta (CKG)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("20.19 WITA");
        }else if(ckereta.getSelectedItem().equals("City Link") && stasiun_tujuan.getSelectedItem().equals("Balikpapan (BPN)")){
            berangkat.setText("06.30 WIB");
            tiba.setText("09.45 WIB");
        }else if(ckereta.getSelectedItem().equals("City Link") && stasiun_tujuan.getSelectedItem().equals("Bandung (BDO)")){
            berangkat.setText("07.20 WIB");
            tiba.setText("16.15 WITA");
        }else if(ckereta.getSelectedItem().equals("City Link") && stasiun_tujuan.getSelectedItem().equals("Surabaya (SUB)")){
            berangkat.setText("06.15 WIB");
            tiba.setText("13.45 WITA");
        }else if(ckereta.getSelectedItem().equals("City Link") && stasiun_tujuan.getSelectedItem().equals("Pontianak (PNK)")){
            berangkat.setText("09.10 WIB");
            tiba.setText("13.03 WITA");
            
            //Argo Parahyangan
        }else if(ckereta.getSelectedItem().equals("Garuda Indonesia") && stasiun_tujuan.getSelectedItem().equals("Jakarta (CKG)")){
            berangkat.setText("07.30 WIB");
            tiba.setText("19.19 WITA");
        }else if(ckereta.getSelectedItem().equals("Garuda Indonesia") && stasiun_tujuan.getSelectedItem().equals("Balikpapan (BPN)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("11.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Garuda Indonesia") && stasiun_tujuan.getSelectedItem().equals("Bandung (BDO)")){
            berangkat.setText("09.20 WIB");
            tiba.setText("18.15 WITA");
        }else if(ckereta.getSelectedItem().equals("Garuda Indonesia") && stasiun_tujuan.getSelectedItem().equals("Surabaya (SUB)")){
            berangkat.setText("08.15 WIB");
            tiba.setText("15.45 WITA");
        }else if(ckereta.getSelectedItem().equals("Garuda Indonesia") && stasiun_tujuan.getSelectedItem().equals("Pontianak (PNK)")){
            berangkat.setText("10.10 WIB");
            tiba.setText("14.03 WITA");
            
            //Lodaya
        }else if(ckereta.getSelectedItem().equals("Lion Air") && stasiun_tujuan.getSelectedItem().equals("Jakarta (CKG)")){
            berangkat.setText("08.15 WIB");
            tiba.setText("20.05 WITA");
        }else if(ckereta.getSelectedItem().equals("Lion Air") && stasiun_tujuan.getSelectedItem().equals("Balikpapan (BPN)")){
            berangkat.setText("10.30 WIB");
            tiba.setText("14.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Lion Air") && stasiun_tujuan.getSelectedItem().equals("Bandung (BDO)")){
            berangkat.setText("07.20 WIB");
            tiba.setText("14.15 WITA");
        }else if(ckereta.getSelectedItem().equals("Lion Air") && stasiun_tujuan.getSelectedItem().equals("Surabaya (SUB")){
            berangkat.setText("07.15 WIB");
            tiba.setText("14.45 WITA");
        }else if(ckereta.getSelectedItem().equals("Lion Air") && stasiun_tujuan.getSelectedItem().equals("Pontianak (PNK)")){
            berangkat.setText("09.10 WIB");
    ...
    private void stasiun_tujuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stasiun_tujuanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_stasiun_tujuanActionPerformed
